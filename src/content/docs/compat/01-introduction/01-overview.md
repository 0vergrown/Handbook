...
| [Ledger](https://modrinth.com/mod/ledger) / Indexor | [Block Logging](/docs/compat/block-logging/overview) | No new types — names the power and origin behind a logged block edit. |
...
Not Enough Recipe Book, Skin Rendering, Sable and Block Logging are neither: they add no types at all. They only change how existing types behave when the other mod is installed.
