...
- [`apoli:voice_speaking`](/docs/compat/simple-voice-chat/voice_speaking) — the same state as a condition.
- [`apoli:action_on_reply`](/docs/compat/simple-voice-chat/action_on_reply)
