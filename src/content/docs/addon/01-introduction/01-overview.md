...
| A new [data type](/docs/datapack/data-types/overview) usable from JSON | A `Codec` + registration |
...
- [The power container](/docs/addon/systems/power-container) — where an entity's powers live.
