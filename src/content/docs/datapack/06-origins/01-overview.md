...
**Origins** is an addon built on Apoli. Apoli gives you [powers](/docs/datapack/powers/overview); Origins gives players a way to *choose* a bundle of them at spawn. An **origin** is that bundle — a name, an icon, some lore, and a list of Apoli powers.
