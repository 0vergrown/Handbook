...
[`apoli:modify_model_parts`](/docs/datapack/powers/modify_model_parts) applies on top of them. Fire
this action from an [`apoli:action_on_key_press`](/docs/datapack/powers/action_on_key_press) that
