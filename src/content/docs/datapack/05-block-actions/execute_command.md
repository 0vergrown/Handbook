...
> A block action has an entity behind it only when something gave it one — a power's block action, a projectile hit. Without one, `resources` has nothing to read and its keys stay undefined.
