...
description: "A String used to determine the type of container to use for the inventory of a power that uses the Inventory."
---

A [String](/docs/datapack/data-types/string) used to determine the type of container to use for the inventory of a power that uses the [apoli:inventory](/docs/datapack/powers/inventory).

> Not to be confused with the [Inventory Type](/docs/datapack/data-types/inventory-type)
