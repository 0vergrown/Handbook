...
- [`origins:stored_origin`](/docs/datapack/origins/stored_origin) — test the store instead of the live choice.
- [`apoli:power`](/docs/datapack/entity-conditions/power) — test for a specific power rather than a whole origin.
- [Origins overview](/docs/datapack/origins/overview) — what an origin is.
- [Layers](/docs/datapack/origins/layers) — what `layer` refers to.
