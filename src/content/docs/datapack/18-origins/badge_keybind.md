...
- [Badges](/docs/datapack/origins/badges) — how badges are attached to a power, and the automatic ones.
- [Key](/docs/datapack/data-types/key) — the key ids you can name.
- [`origins:tooltip`](/docs/datapack/origins/badge_tooltip) — for text that isn't about a key.
