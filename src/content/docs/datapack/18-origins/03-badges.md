...
- [Origins overview](/docs/datapack/origins/overview) — what a badge is annotating.
- [`apoli:multiple`](/docs/datapack/powers/multiple) — how bundled traits merge their badges.
