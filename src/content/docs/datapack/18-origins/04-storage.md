...
- [`origins:transfer_origin`](/docs/datapack/origins/transfer_origin) — move an origin between players directly, without going through the store.
- [Layers](/docs/datapack/origins/layers) — what the `layer` field on every storage type refers to.
