...
description: "Prevents the entity that has the power from flying with either an Elytra item or a power that uses the apoli:elytraflight."
navigation_title: "Prevent Elytra Flight"
---
