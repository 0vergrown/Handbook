...
`count` | Integer or [Expression](/docs/datapack/data-types/expression) | `1` | Determines the amount of particles to spawn.
...
`frequency` | Integer or [Expression](/docs/datapack/data-types/expression) | | Determines how often the particles should spawn (interval in ticks).
